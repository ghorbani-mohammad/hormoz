...
<div class="row" style="margin-top: 15px;">
	<div class="col-6">
		...
		<br>
		<span style="font-size: 0.9rem;"><i class="fa fa-map-marker" aria-hidden="true"></i> آدرس: تهران، خیابان سعدی جنوبی، مجتمع تجاری سعدی، طبقه دوم، واحد {{persianumber("207")}}</span>
		<br>
