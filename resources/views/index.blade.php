			...
			<div>
				<div class="row mt-4">
					<div class="card col-sm-6 col-md-3" style="background-color: #e9ecef;border: none;">
						<img class="card-img-top" src="images/traycable.jpg" style="height: 200px;">
						<div class="card-body">
					...
					<div class="card col-sm-6 col-md-3" style="background-color: #e9ecef;border: none;">
						<img class="card-img-top" src="images/ladder.jpg" style="height: 200px;">
						<div class="card-body">
					...
					<div class="card col-sm-6 col-md-3" style="background-color: #e9ecef;border: none;">
						<img class="card-img-top" src="images/pipe.jpg" style="height: 200px;">
						<div class="card-body">
					...
					<div class="card col-sm-6 col-md-3" style="background-color: #e9ecef;border: none;">
						<img class="card-img-top" src="images/pipe-flexi.jpg" style="height: 200px;">
						<div class="card-body">
